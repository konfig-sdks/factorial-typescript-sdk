...
export const PolicyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getTimeOff: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getTimeOff', 'id', id)
            const localVarPath = `/v1/time/policies/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/time/policies/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        getTimeOffPolicies: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/time/policies`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const PolicyApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * This endpoint allows you to retrieve a time off policy for a company
         * @summary Get a Time off Policy
         * @param {PolicyApiGetTimeOffRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getTimeOff(requestParameters: PolicyApiGetTimeOffRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Policy>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTimeOff(requestParameters.id, options);
         ...
         * @throws {RequiredError}
         */
        async getTimeOffPolicies(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Policy>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTimeOffPolicies(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const PolicyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTimeOff(requestParameters: PolicyApiGetTimeOffRequest, options?: AxiosRequestConfig): AxiosPromise<Policy> {
            return localVarFp.getTimeOff(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint allows you to retrieve time off policies for a company
         * @summary Get Time off Policies
         ...
         * @throws {RequiredError}
         */
        getTimeOffPolicies(options?: AxiosRequestConfig): AxiosPromise<Array<Policy>> {
            return localVarFp.getTimeOffPolicies(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getTimeOff operation in PolicyApi.
 * @export
 * @interface PolicyApiGetTimeOffRequest
 */
export type PolicyApiGetTimeOffRequest = {
    
    /**
    * (Required)
    * @type {number}
    * @memberof PolicyApiGetTimeOff
    */
    readonly id: number
...
/**
 * PolicyApiGenerated - object-oriented interface
 * @export
 * @class PolicyApiGenerated
 * @extends {BaseAPI}
 */
export class PolicyApiGenerated extends BaseAPI {
    /**
     * This endpoint allows you to retrieve a time off policy for a company
     * @summary Get a Time off Policy
     * @param {PolicyApiGetTimeOffRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PolicyApiGenerated
     */
    public getTimeOff(requestParameters: PolicyApiGetTimeOffRequest, options?: AxiosRequestConfig) {
        return PolicyApiFp(this.configuration).getTimeOff(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PolicyApiGenerated
     */
    public getTimeOffPolicies(options?: AxiosRequestConfig) {
        return PolicyApiFp(this.configuration).getTimeOffPolicies(options).then((request) => request(this.axios, this.basePath));
    }
}
