...
// @ts-ignore
import { SupplementCreateNewSupplementRequest } from '../models';
// @ts-ignore
import { SupplementUpdateByIdRequest } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * SupplementApi - axios parameter creator
 * @export
 */
export const SupplementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Create supplements
         * @summary Create supplements
         * @param {SupplementCreateNewSupplementRequest} [supplementCreateNewSupplementRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewSupplement: async (supplementCreateNewSupplementRequest?: SupplementCreateNewSupplementRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/payroll/supplements`;
            ...
            requestBeforeHook({
                requestBody: supplementCreateNewSupplementRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/payroll/supplements',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(supplementCreateNewSupplementRequest, localVarRequestOptions, configuration)
        ...
        deleteById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/payroll/supplements/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/payroll/supplements/{id}',
                httpMethod: 'DELETE'
            });
         ...
         * @param {string} id (Required)
         * @param {SupplementUpdateByIdRequest} [supplementUpdateByIdRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateById: async (id: string, supplementUpdateByIdRequest?: SupplementUpdateByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: supplementUpdateByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(supplementUpdateByIdRequest, localVarRequestOptions, configuration)
...
/**
 * SupplementApi - functional programming interface
 * @export
 */
export const SupplementApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = SupplementApiAxiosParamCreator(configuration)
    return {
        /**
         * Create supplements
         * @summary Create supplements
         * @param {SupplementApiCreateNewSupplementRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewSupplement(requestParameters: SupplementApiCreateNewSupplementRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Supplement>> {
            const supplementCreateNewSupplementRequest: SupplementCreateNewSupplementRequest = {
                employee_id: requestParameters.employee_id,
                amount_in_cents: requestParameters.amount_in_cents,
                effective_on: requestParameters.effective_on,
                contracts_taxonomy_id: requestParameters.contracts_taxonomy_id,
                payroll_policy_period_id: requestParameters.payroll_policy_period_id,
                unit: requestParameters.unit,
                contracts_compensation_id: requestParameters.contracts_compensation_id
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewSupplement(supplementCreateNewSupplementRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete supplements
         * @summary Delete supplements
         * @param {SupplementApiDeleteByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteById(requestParameters: SupplementApiDeleteByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Supplement>> {
         ...
         * @throws {RequiredError}
         */
        async getAll(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Supplement>>> {
         ...
         * Update supplements
         * @summary Update supplements
         * @param {SupplementApiUpdateByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateById(requestParameters: SupplementApiUpdateByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Supplement>> {
            const supplementUpdateByIdRequest: SupplementUpdateByIdRequest = {
                employee_id: requestParameters.employee_id,
                amount_in_cents: requestParameters.amount_in_cents,
                effective_on: requestParameters.effective_on,
                contracts_taxonomy_id: requestParameters.contracts_taxonomy_id,
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateById(requestParameters.id, supplementUpdateByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * SupplementApi - factory interface
 * @export
 */
export const SupplementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = SupplementApiFp(configuration)
    return {
        /**
         * Create supplements
         * @summary Create supplements
         ...
         * @throws {RequiredError}
         */
        createNewSupplement(requestParameters: SupplementApiCreateNewSupplementRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Supplement> {
            return localVarFp.createNewSupplement(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete supplements
         * @summary Delete supplements
         ...
         * @throws {RequiredError}
         */
        deleteById(requestParameters: SupplementApiDeleteByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Supplement> {
         ...
         * @throws {RequiredError}
         */
        getAll(options?: AxiosRequestConfig): AxiosPromise<Array<Supplement>> {
         ...
         * @throws {RequiredError}
         */
        updateById(requestParameters: SupplementApiUpdateByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Supplement> {
...
/**
 * Request parameters for createNewSupplement operation in SupplementApi.
 * @export
 * @interface SupplementApiCreateNewSupplementRequest
 */
export type SupplementApiCreateNewSupplementRequest = {
    
} & SupplementCreateNewSupplementRequest

/**
 * Request parameters for deleteById operation in SupplementApi.
 * @export
 * @interface SupplementApiDeleteByIdRequest
 */
export type SupplementApiDeleteByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof SupplementApiDeleteById
    */
    readonly id: string
...
/**
 * Request parameters for updateById operation in SupplementApi.
 * @export
 * @interface SupplementApiUpdateByIdRequest
 */
export type SupplementApiUpdateByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof SupplementApiUpdateById
    */
    readonly id: string
...
/**
 * SupplementApiGenerated - object-oriented interface
 * @export
 * @class SupplementApiGenerated
 * @extends {BaseAPI}
 */
export class SupplementApiGenerated extends BaseAPI {
    /**
     * Create supplements
     * @summary Create supplements
     * @param {SupplementApiCreateNewSupplementRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SupplementApiGenerated
     */
    public createNewSupplement(requestParameters: SupplementApiCreateNewSupplementRequest = {}, options?: AxiosRequestConfig) {
        return SupplementApiFp(this.configuration).createNewSupplement(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SupplementApiGenerated
     */
    public deleteById(requestParameters: SupplementApiDeleteByIdRequest, options?: AxiosRequestConfig) {
        return SupplementApiFp(this.configuration).deleteById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAll(options?: AxiosRequestConfig) {
        return SupplementApiFp(this.configuration).getAll(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SupplementApiGenerated
     */
    public updateById(requestParameters: SupplementApiUpdateByIdRequest, options?: AxiosRequestConfig) {
        return SupplementApiFp(this.configuration).updateById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
