...
// @ts-ignore
import { LocationUpdateShiftLocationRequest } from '../models';
// @ts-ignore
...
export const LocationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAllLocations: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} id (Required)
         * @param {LocationUpdateShiftLocationRequest} [locationUpdateShiftLocationRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateShiftLocation: async (id: string, locationUpdateShiftLocationRequest?: LocationUpdateShiftLocationRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateShiftLocation', 'id', id)
            const localVarPath = `/v1/time/shifts_management/{id}/locations`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: locationUpdateShiftLocationRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/time/shifts_management/{id}/locations',
                httpMethod: 'PUT'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(locationUpdateShiftLocationRequest, localVarRequestOptions, configuration)
...
export const LocationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllLocations(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Location>>> {
         ...
         * Get a Location by ID
         * @summary Get a Location by ID
         * @param {LocationApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: LocationApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Location>> {
         ...
         * Update shift location
         * @summary Update shift location
         * @param {LocationApiUpdateShiftLocationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateShiftLocation(requestParameters: LocationApiUpdateShiftLocationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShiftManagement>> {
            const locationUpdateShiftLocationRequest: LocationUpdateShiftLocationRequest = {
                location_id: requestParameters.location_id,
                work_area_id: requestParameters.work_area_id
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateShiftLocation(requestParameters.id, locationUpdateShiftLocationRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const LocationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllLocations(options?: AxiosRequestConfig): AxiosPromise<Array<Location>> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: LocationApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Location> {
         ...
         * @throws {RequiredError}
         */
        updateShiftLocation(requestParameters: LocationApiUpdateShiftLocationRequest, options?: AxiosRequestConfig): AxiosPromise<ShiftManagement> {
            return localVarFp.updateShiftLocation(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getById operation in LocationApi.
 * @export
 * @interface LocationApiGetByIdRequest
 */
export type LocationApiGetByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof LocationApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for updateShiftLocation operation in LocationApi.
 * @export
 * @interface LocationApiUpdateShiftLocationRequest
 */
export type LocationApiUpdateShiftLocationRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof LocationApiUpdateShiftLocation
    */
    readonly id: string
...
export class LocationApiGenerated extends BaseAPI {
     ...
     */
    public getAllLocations(options?: AxiosRequestConfig) {
        return LocationApiFp(this.configuration).getAllLocations(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocationApiGenerated
     */
    public getById(requestParameters: LocationApiGetByIdRequest, options?: AxiosRequestConfig) {
        return LocationApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocationApiGenerated
     */
    public updateShiftLocation(requestParameters: LocationApiUpdateShiftLocationRequest, options?: AxiosRequestConfig) {
        return LocationApiFp(this.configuration).updateShiftLocation(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
