...
export const EventApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getTriggeredEvents: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/core/events`;
...
export const EventApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTriggeredEvents(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Event>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTriggeredEvents(options);
...
export const EventApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTriggeredEvents(options?: AxiosRequestConfig): AxiosPromise<Array<Event>> {
            return localVarFp.getTriggeredEvents(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EventApiGenerated extends BaseAPI {
     ...
     */
    public getTriggeredEvents(options?: AxiosRequestConfig) {
        return EventApiFp(this.configuration).getTriggeredEvents(options).then((request) => request(this.axios, this.basePath));
    }
}
