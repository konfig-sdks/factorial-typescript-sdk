...
export const HolidayApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAllCompanyHolidays: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/company_holidays`;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/company_holidays',
                httpMethod: 'GET'
            });
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/company_holidays/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/company_holidays/{id}',
                httpMethod: 'GET'
            });
...
export const HolidayApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllCompanyHolidays(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CompanyHoliday>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllCompanyHolidays(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a company holiday by ID
         * @summary Get a company holiday by ID
         * @param {HolidayApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: HolidayApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CompanyHoliday>> {
...
export const HolidayApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllCompanyHolidays(options?: AxiosRequestConfig): AxiosPromise<Array<CompanyHoliday>> {
            return localVarFp.getAllCompanyHolidays(options).then((request) => request(axios, basePath));
        },
        /**
         * Get a company holiday by ID
         * @summary Get a company holiday by ID
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: HolidayApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CompanyHoliday> {
...
/**
 * Request parameters for getById operation in HolidayApi.
 * @export
 * @interface HolidayApiGetByIdRequest
 */
export type HolidayApiGetByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof HolidayApiGetById
    */
    readonly id: string
...
/**
 * HolidayApiGenerated - object-oriented interface
 * @export
 * @class HolidayApiGenerated
 * @extends {BaseAPI}
 */
export class HolidayApiGenerated extends BaseAPI {
    /**
     * Get all company holidays
     * @summary Get all company holidays
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof HolidayApiGenerated
     */
    public getAllCompanyHolidays(options?: AxiosRequestConfig) {
        return HolidayApiFp(this.configuration).getAllCompanyHolidays(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof HolidayApiGenerated
     */
    public getById(requestParameters: HolidayApiGetByIdRequest, options?: AxiosRequestConfig) {
        return HolidayApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
