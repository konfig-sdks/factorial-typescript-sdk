...
// @ts-ignore
import { IntegrationCodeCreatePayrollIntegrationCodeRequest } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * IntegrationCodeApi - axios parameter creator
 * @export
 */
export const IntegrationCodeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {IntegrationCodeCreatePayrollIntegrationCodeRequest} [integrationCodeCreatePayrollIntegrationCodeRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createPayrollIntegrationCode: async (integrationCodeCreatePayrollIntegrationCodeRequest?: IntegrationCodeCreatePayrollIntegrationCodeRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            requestBeforeHook({
                requestBody: integrationCodeCreatePayrollIntegrationCodeRequest,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(integrationCodeCreatePayrollIntegrationCodeRequest, localVarRequestOptions, configuration)
...
/**
 * IntegrationCodeApi - functional programming interface
 * @export
 */
export const IntegrationCodeApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = IntegrationCodeApiAxiosParamCreator(configuration)
    return {
        /**
         * This endpoint allows you create and store Payroll Integrations Codes in Factorial.
         * @summary Create a Payroll Integration Code
         * @param {IntegrationCodeApiCreatePayrollIntegrationCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createPayrollIntegrationCode(requestParameters: IntegrationCodeApiCreatePayrollIntegrationCodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Code>> {
            const integrationCodeCreatePayrollIntegrationCodeRequest: IntegrationCodeCreatePayrollIntegrationCodeRequest = {
                code: requestParameters.code,
                codeable_id: requestParameters.codeable_id,
                codeable_type: requestParameters.codeable_type,
                integration: requestParameters.integration,
                forfait_jours: requestParameters.forfait_jours
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createPayrollIntegrationCode(integrationCodeCreatePayrollIntegrationCodeRequest, options);
...
/**
 * IntegrationCodeApi - factory interface
 * @export
 */
export const IntegrationCodeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = IntegrationCodeApiFp(configuration)
    return {
        /**
         * This endpoint allows you create and store Payroll Integrations Codes in Factorial.
         * @summary Create a Payroll Integration Code
         ...
         * @throws {RequiredError}
         */
        createPayrollIntegrationCode(requestParameters: IntegrationCodeApiCreatePayrollIntegrationCodeRequest, options?: AxiosRequestConfig): AxiosPromise<Code> {
            return localVarFp.createPayrollIntegrationCode(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createPayrollIntegrationCode operation in IntegrationCodeApi.
 * @export
 * @interface IntegrationCodeApiCreatePayrollIntegrationCodeRequest
 */
export type IntegrationCodeApiCreatePayrollIntegrationCodeRequest = {
    
} & IntegrationCodeCreatePayrollIntegrationCodeRequest

/**
 * IntegrationCodeApiGenerated - object-oriented interface
 * @export
 * @class IntegrationCodeApiGenerated
 * @extends {BaseAPI}
 */
export class IntegrationCodeApiGenerated extends BaseAPI {
    /**
     * This endpoint allows you create and store Payroll Integrations Codes in Factorial.
     * @summary Create a Payroll Integration Code
     * @param {IntegrationCodeApiCreatePayrollIntegrationCodeRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof IntegrationCodeApiGenerated
     */
    public createPayrollIntegrationCode(requestParameters: IntegrationCodeApiCreatePayrollIntegrationCodeRequest, options?: AxiosRequestConfig) {
        return IntegrationCodeApiFp(this.configuration).createPayrollIntegrationCode(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
