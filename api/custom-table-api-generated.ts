...
/**
 * CustomTableApi - axios parameter creator
 * @export
 */
export const CustomTableApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * This endpoint allows you to retrieve Custom Tables
         * @summary Get Custom Tables
         * @param {string} [topicName] Filters by topic_name
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        get: async (topicName?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
/**
 * CustomTableApi - functional programming interface
 * @export
 */
export const CustomTableApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CustomTableApiAxiosParamCreator(configuration)
    return {
        /**
         * This endpoint allows you to retrieve Custom Tables
         * @summary Get Custom Tables
         * @param {CustomTableApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: CustomTableApiGetRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CustomResource>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get(requestParameters.topicName, options);
...
/**
 * CustomTableApi - factory interface
 * @export
 */
export const CustomTableApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CustomTableApiFp(configuration)
    return {
        /**
         * This endpoint allows you to retrieve Custom Tables
         * @summary Get Custom Tables
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: CustomTableApiGetRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<CustomResource>> {
...
/**
 * Request parameters for get operation in CustomTableApi.
 * @export
 * @interface CustomTableApiGetRequest
 */
export type CustomTableApiGetRequest = {
    
    /**
    * Filters by topic_name
    * @type {string}
    * @memberof CustomTableApiGet
    */
...
/**
 * CustomTableApiGenerated - object-oriented interface
 * @export
 * @class CustomTableApiGenerated
 * @extends {BaseAPI}
 */
export class CustomTableApiGenerated extends BaseAPI {
    /**
     * This endpoint allows you to retrieve Custom Tables
     * @summary Get Custom Tables
     * @param {CustomTableApiGetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CustomTableApiGenerated
     */
    public get(requestParameters: CustomTableApiGetRequest = {}, options?: AxiosRequestConfig) {
        return CustomTableApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
