...
export const LegalEntityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/core/legal_entities/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/core/legal_entities/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listLegalEntities: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/core/legal_entities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/core/legal_entities',
                httpMethod: 'GET'
            });
...
export const LegalEntityApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Get a Legal Entity by ID
         * @summary Get a Legal Entity by ID
         * @param {LegalEntityApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: LegalEntityApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LegalEntity>> {
         ...
         * @throws {RequiredError}
         */
        async listLegalEntities(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LegalEntity>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listLegalEntities(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const LegalEntityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: LegalEntityApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<LegalEntity> {
         ...
         * @throws {RequiredError}
         */
        listLegalEntities(options?: AxiosRequestConfig): AxiosPromise<Array<LegalEntity>> {
            return localVarFp.listLegalEntities(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getById operation in LegalEntityApi.
 * @export
 * @interface LegalEntityApiGetByIdRequest
 */
export type LegalEntityApiGetByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof LegalEntityApiGetById
    */
    readonly id: string
...
/**
 * LegalEntityApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityApiGenerated extends BaseAPI {
    /**
     * Get a Legal Entity by ID
     * @summary Get a Legal Entity by ID
     * @param {LegalEntityApiGetByIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityApiGenerated
     */
    public getById(requestParameters: LegalEntityApiGetByIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LegalEntityApiGenerated
     */
    public listLegalEntities(options?: AxiosRequestConfig) {
        return LegalEntityApiFp(this.configuration).listLegalEntities(options).then((request) => request(this.axios, this.basePath));
    }
}
