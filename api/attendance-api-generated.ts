...
// @ts-ignore
import { AttendanceCreateNewRequest } from '../models';
...
export const AttendanceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AttendanceCreateNewRequest} [attendanceCreateNewRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNew: async (attendanceCreateNewRequest?: AttendanceCreateNewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/time/attendance`;
            ...
            requestBeforeHook({
                requestBody: attendanceCreateNewRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v2/time/attendance',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(attendanceCreateNewRequest, localVarRequestOptions, configuration)
        ...
        getBulkV2: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/core/bulk/attendance`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v2/core/bulk/attendance',
                httpMethod: 'POST'
            });
         ...
         * @param {string} [dateFrom] It should be a valid date following the format YYYY-MM-DD
         * @param {string} [dateTo] It should be a valid date following the format YYYY-MM-DD
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCompanyAttendance: async (employeeIds?: Array<number>, dateFrom?: string, dateTo?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/time/attendance`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AttendanceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Creates Attendance
         * @summary Create Attendance
         * @param {AttendanceApiCreateNewRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNew(requestParameters: AttendanceApiCreateNewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Attendance>> {
            const attendanceCreateNewRequest: AttendanceCreateNewRequest = {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNew(attendanceCreateNewRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getBulkV2(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Attendance>>> {
         ...
         * Get attendance from a company
         * @summary Get attendance from a company
         * @param {AttendanceApiGetCompanyAttendanceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getCompanyAttendance(requestParameters: AttendanceApiGetCompanyAttendanceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Attendance>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCompanyAttendance(requestParameters.employeeIds, requestParameters.dateFrom, requestParameters.dateTo, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AttendanceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNew(requestParameters: AttendanceApiCreateNewRequest, options?: AxiosRequestConfig): AxiosPromise<Attendance> {
         ...
         * @throws {RequiredError}
         */
        getBulkV2(options?: AxiosRequestConfig): AxiosPromise<Array<Attendance>> {
         ...
         * @throws {RequiredError}
         */
        getCompanyAttendance(requestParameters: AttendanceApiGetCompanyAttendanceRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Attendance>> {
            return localVarFp.getCompanyAttendance(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNew operation in AttendanceApi.
 * @export
 * @interface AttendanceApiCreateNewRequest
 */
export type AttendanceApiCreateNewRequest = {
    
} & AttendanceCreateNewRequest

/**
 * Request parameters for getCompanyAttendance operation in AttendanceApi.
 * @export
 * @interface AttendanceApiGetCompanyAttendanceRequest
 */
export type AttendanceApiGetCompanyAttendanceRequest = {
    
    /**
    * Employees id array
    * @type {Array<number>}
    * @memberof AttendanceApiGetCompanyAttendance
    */
...
export class AttendanceApiGenerated extends BaseAPI {
     ...
     */
    public createNew(requestParameters: AttendanceApiCreateNewRequest, options?: AxiosRequestConfig) {
        return AttendanceApiFp(this.configuration).createNew(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBulkV2(options?: AxiosRequestConfig) {
        return AttendanceApiFp(this.configuration).getBulkV2(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttendanceApiGenerated
     */
    public getCompanyAttendance(requestParameters: AttendanceApiGetCompanyAttendanceRequest, options?: AxiosRequestConfig) {
        return AttendanceApiFp(this.configuration).getCompanyAttendance(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
