...
// @ts-ignore
import { TeamCreateNewTeamRequest } from '../models';
// @ts-ignore
...
export const TeamApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TeamCreateNewTeamRequest} [teamCreateNewTeamRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewTeam: async (teamCreateNewTeamRequest?: TeamCreateNewTeamRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/core/teams`;
            ...
            requestBeforeHook({
                requestBody: teamCreateNewTeamRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/core/teams',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(teamCreateNewTeamRequest, localVarRequestOptions, configuration)
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/core/teams/{id}`
         ...
         * @throws {RequiredError}
         */
        removeTeam: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @param {string} id (Required)
         * @param {TeamUpdateTeamByIdRequest} [teamUpdateTeamByIdRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const TeamApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Create a team with a given name
         * @summary Create a team
         * @param {TeamApiCreateNewTeamRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewTeam(requestParameters: TeamApiCreateNewTeamRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Team>> {
            const teamCreateNewTeamRequest: TeamCreateNewTeamRequest = {
                description: requestParameters.description,
                name: requestParameters.name
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewTeam(teamCreateNewTeamRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getAllTeams(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Team>>> {
         ...
         * Get a team by ID
         * @summary Get a team by ID
         * @param {TeamApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: TeamApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Team>>> {
         ...
         * Delete a team
         * @summary Delete a team
         * @param {TeamApiRemoveTeamRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeTeam(requestParameters: TeamApiRemoveTeamRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Team>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeTeam(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a team
         ...
         * @throws {RequiredError}
         */
        async updateTeamById(requestParameters: TeamApiUpdateTeamByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Team>> {
...
export const TeamApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNewTeam(requestParameters: TeamApiCreateNewTeamRequest, options?: AxiosRequestConfig): AxiosPromise<Team> {
         ...
         * @throws {RequiredError}
         */
        getAllTeams(options?: AxiosRequestConfig): AxiosPromise<Array<Team>> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: TeamApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Team>> {
         ...
         * @throws {RequiredError}
         */
        removeTeam(requestParameters: TeamApiRemoveTeamRequest, options?: AxiosRequestConfig): AxiosPromise<Team> {
         ...
         * @throws {RequiredError}
         */
        updateTeamById(requestParameters: TeamApiUpdateTeamByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Team> {
...
/**
 * Request parameters for createNewTeam operation in TeamApi.
 * @export
 * @interface TeamApiCreateNewTeamRequest
 */
export type TeamApiCreateNewTeamRequest = {
    
} & TeamCreateNewTeamRequest

/**
 * Request parameters for getById operation in TeamApi.
 * @export
 * @interface TeamApiGetByIdRequest
 */
export type TeamApiGetByIdRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof TeamApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for removeTeam operation in TeamApi.
 * @export
 * @interface TeamApiRemoveTeamRequest
 */
export type TeamApiRemoveTeamRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof TeamApiRemoveTeam
    */
    readonly id: string
...
export class TeamApiGenerated extends BaseAPI {
     ...
     */
    public createNewTeam(requestParameters: TeamApiCreateNewTeamRequest, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).createNewTeam(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamApiGenerated
     */
    public getById(requestParameters: TeamApiGetByIdRequest, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamApiGenerated
     */
    public removeTeam(requestParameters: TeamApiRemoveTeamRequest, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).removeTeam(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
