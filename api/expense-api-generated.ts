...
export const ExpenseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getById: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/finance/expenses/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/finance/expenses/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        getCompanyExpenses: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/finance/expenses`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/finance/expenses',
                httpMethod: 'GET'
            });
...
export const ExpenseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * This endpoint allows you to retrieve an expense by id
         * @summary Get an expense
         * @param {ExpenseApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @deprecated
         * @throws {RequiredError}
         */
        async getById(requestParameters: ExpenseApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Expense>> {
         ...
         * @throws {RequiredError}
         */
        async getCompanyExpenses(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Expense>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCompanyExpenses(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ExpenseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: ExpenseApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<Expense> {
         ...
         * @throws {RequiredError}
         */
        getCompanyExpenses(options?: AxiosRequestConfig): AxiosPromise<Array<Expense>> {
            return localVarFp.getCompanyExpenses(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getById operation in ExpenseApi.
 * @export
 * @interface ExpenseApiGetByIdRequest
 */
export type ExpenseApiGetByIdRequest = {
    
    /**
    * (Required)
    * @type {number}
    * @memberof ExpenseApiGetById
    */
    readonly id: number
...
export class ExpenseApiGenerated extends BaseAPI {
     ...
     */
    public getById(requestParameters: ExpenseApiGetByIdRequest, options?: AxiosRequestConfig) {
        return ExpenseApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ExpenseApiGenerated
     */
    public getCompanyExpenses(options?: AxiosRequestConfig) {
        return ExpenseApiFp(this.configuration).getCompanyExpenses(options).then((request) => request(this.axios, this.basePath));
    }
}
