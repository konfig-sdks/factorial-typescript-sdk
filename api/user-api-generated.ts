...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        subscribedWebhooksList: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        subscribedWebhooksList_1: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async subscribedWebhooksList(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WebhookV2>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.subscribedWebhooksList(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of all subscribed webhooks for current user
         ...
         * @throws {RequiredError}
         */
        async subscribedWebhooksList_1(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Webhook>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.subscribedWebhooksList_1(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        infoGet(options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        subscribedWebhooksList(options?: AxiosRequestConfig): AxiosPromise<Array<WebhookV2>> {
            return localVarFp.subscribedWebhooksList(options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of all subscribed webhooks for current user
         * @summary Get a list of all subscribed webhooks for current user
         ...
         * @throws {RequiredError}
         */
        subscribedWebhooksList_1(options?: AxiosRequestConfig): AxiosPromise<Array<Webhook>> {
            return localVarFp.subscribedWebhooksList_1(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserApiGenerated extends BaseAPI {
     ...
     * @memberof UserApiGenerated
     */
    public subscribedWebhooksList(options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).subscribedWebhooksList(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UserApiGenerated
     */
    public subscribedWebhooksList_1(options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).subscribedWebhooksList_1(options).then((request) => request(this.axios, this.basePath));
    }
}
