...
// @ts-ignore
import { ContractVersionCreateNewVersionRequest } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ContractVersionApi - axios parameter creator
 * @export
 */
export const ContractVersionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Create contract Versions
         * @summary Create contract versions
         * @param {ContractVersionCreateNewVersionRequest} [contractVersionCreateNewVersionRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewVersion: async (contractVersionCreateNewVersionRequest?: ContractVersionCreateNewVersionRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/payroll/contract_versions`;
            ...
            requestBeforeHook({
                requestBody: contractVersionCreateNewVersionRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/payroll/contract_versions',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(contractVersionCreateNewVersionRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getAllVersions: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/payroll/contract_versions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getBulkVersions: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/core/bulk/contract_version`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v2/core/bulk/contract_version',
                httpMethod: 'POST'
            });
...
/**
 * ContractVersionApi - functional programming interface
 * @export
 */
export const ContractVersionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ContractVersionApiAxiosParamCreator(configuration)
    return {
        /**
         * Create contract Versions
         * @summary Create contract versions
         * @param {ContractVersionApiCreateNewVersionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewVersion(requestParameters: ContractVersionApiCreateNewVersionRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContractVersion>> {
            const contractVersionCreateNewVersionRequest: ContractVersionCreateNewVersionRequest = {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewVersion(contractVersionCreateNewVersionRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getAllVersions(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContractVersion>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllVersions(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint allows you retrieve bulk contract versions
         ...
         * @throws {RequiredError}
         */
        async getBulkVersions(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContractVersion>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBulkVersions(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ContractVersionApi - factory interface
 * @export
 */
export const ContractVersionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ContractVersionApiFp(configuration)
    return {
        /**
         * Create contract Versions
         * @summary Create contract versions
         ...
         * @throws {RequiredError}
         */
        createNewVersion(requestParameters: ContractVersionApiCreateNewVersionRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ContractVersion> {
         ...
         * @throws {RequiredError}
         */
        getAllVersions(options?: AxiosRequestConfig): AxiosPromise<Array<ContractVersion>> {
            return localVarFp.getAllVersions(options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint allows you retrieve bulk contract versions
         * @summary Get Bulk Contract Versions
         ...
         * @throws {RequiredError}
         */
        getBulkVersions(options?: AxiosRequestConfig): AxiosPromise<Array<ContractVersion>> {
            return localVarFp.getBulkVersions(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewVersion operation in ContractVersionApi.
 * @export
 * @interface ContractVersionApiCreateNewVersionRequest
 */
export type ContractVersionApiCreateNewVersionRequest = {
    
} & ContractVersionCreateNewVersionRequest

/**
 * ContractVersionApiGenerated - object-oriented interface
 * @export
 * @class ContractVersionApiGenerated
 * @extends {BaseAPI}
 */
export class ContractVersionApiGenerated extends BaseAPI {
    /**
     * Create contract Versions
     * @summary Create contract versions
     * @param {ContractVersionApiCreateNewVersionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ContractVersionApiGenerated
     */
    public createNewVersion(requestParameters: ContractVersionApiCreateNewVersionRequest = {}, options?: AxiosRequestConfig) {
        return ContractVersionApiFp(this.configuration).createNewVersion(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContractVersionApiGenerated
     */
    public getAllVersions(options?: AxiosRequestConfig) {
        return ContractVersionApiFp(this.configuration).getAllVersions(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContractVersionApiGenerated
     */
    public getBulkVersions(options?: AxiosRequestConfig) {
        return ContractVersionApiFp(this.configuration).getBulkVersions(options).then((request) => request(this.axios, this.basePath));
    }
}
