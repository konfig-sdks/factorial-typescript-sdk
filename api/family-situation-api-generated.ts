...
// @ts-ignore
import { FamilySituationCreateNewRequest } from '../models';
// @ts-ignore
import { FamilySituationUpdateFamilySituationRequest } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * FamilySituationApi - axios parameter creator
 * @export
 */
export const FamilySituationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Create a Family Situation
         * @summary Create a Family Situation
         * @param {FamilySituationCreateNewRequest} [familySituationCreateNewRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNew: async (familySituationCreateNewRequest?: FamilySituationCreateNewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            requestBeforeHook({
                requestBody: familySituationCreateNewRequest,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(familySituationCreateNewRequest, localVarRequestOptions, configuration)
         ...
         * @param {FamilySituationUpdateFamilySituationRequest} [familySituationUpdateFamilySituationRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFamilySituation: async (id: string, familySituationUpdateFamilySituationRequest?: FamilySituationUpdateFamilySituationRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateFamilySituation', 'id', id)
            const localVarPath = `/v1/payroll/family_situation/{id}`
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: familySituationUpdateFamilySituationRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/payroll/family_situation/{id}',
                httpMethod: 'PUT'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(familySituationUpdateFamilySituationRequest, localVarRequestOptions, configuration)
...
/**
 * FamilySituationApi - functional programming interface
 * @export
 */
export const FamilySituationApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = FamilySituationApiAxiosParamCreator(configuration)
    return {
        /**
         * Create a Family Situation
         * @summary Create a Family Situation
         * @param {FamilySituationApiCreateNewRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNew(requestParameters: FamilySituationApiCreateNewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FamilySituation>> {
            const familySituationCreateNewRequest: FamilySituationCreateNewRequest = {
                employee_id: requestParameters.employee_id,
                civil_status: requestParameters.civil_status,
                number_of_dependants: requestParameters.number_of_dependants
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNew(familySituationCreateNewRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a Family Situation
         * @summary Update a Family Situation
         * @param {FamilySituationApiUpdateFamilySituationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateFamilySituation(requestParameters: FamilySituationApiUpdateFamilySituationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FamilySituation>> {
            const familySituationUpdateFamilySituationRequest: FamilySituationUpdateFamilySituationRequest = {
                employee_id: requestParameters.employee_id,
                civil_status: requestParameters.civil_status,
                number_of_dependants: requestParameters.number_of_dependants
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateFamilySituation(requestParameters.id, familySituationUpdateFamilySituationRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * FamilySituationApi - factory interface
 * @export
 */
export const FamilySituationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = FamilySituationApiFp(configuration)
    return {
        /**
         * Create a Family Situation
         * @summary Create a Family Situation
         ...
         * @throws {RequiredError}
         */
        createNew(requestParameters: FamilySituationApiCreateNewRequest, options?: AxiosRequestConfig): AxiosPromise<FamilySituation> {
         ...
         * @throws {RequiredError}
         */
        updateFamilySituation(requestParameters: FamilySituationApiUpdateFamilySituationRequest, options?: AxiosRequestConfig): AxiosPromise<FamilySituation> {
            return localVarFp.updateFamilySituation(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNew operation in FamilySituationApi.
 * @export
 * @interface FamilySituationApiCreateNewRequest
 */
export type FamilySituationApiCreateNewRequest = {
    
} & FamilySituationCreateNewRequest

/**
 * Request parameters for updateFamilySituation operation in FamilySituationApi.
 * @export
 * @interface FamilySituationApiUpdateFamilySituationRequest
 */
export type FamilySituationApiUpdateFamilySituationRequest = {
    
    /**
    * (Required)
    * @type {string}
    * @memberof FamilySituationApiUpdateFamilySituation
    */
    readonly id: string
...
/**
 * FamilySituationApiGenerated - object-oriented interface
 * @export
 * @class FamilySituationApiGenerated
 * @extends {BaseAPI}
 */
export class FamilySituationApiGenerated extends BaseAPI {
    /**
     * Create a Family Situation
     * @summary Create a Family Situation
     * @param {FamilySituationApiCreateNewRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FamilySituationApiGenerated
     */
    public createNew(requestParameters: FamilySituationApiCreateNewRequest, options?: AxiosRequestConfig) {
        return FamilySituationApiFp(this.configuration).createNew(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FamilySituationApiGenerated
     */
    public updateFamilySituation(requestParameters: FamilySituationApiUpdateFamilySituationRequest, options?: AxiosRequestConfig) {
        return FamilySituationApiFp(this.configuration).updateFamilySituation(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
