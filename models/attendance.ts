...
export interface Attendance {
     ...
     * @memberof Attendance
     */
    'location_type'?: AttendanceLocationTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof Attendance
     */
    'half_day'?: AttendanceHalfDayEnum;
    /**
     * 
     * @type {number}
     * @memberof Attendance
     ...
     * @memberof Attendance
     */
    'automatic_clock_out'?: boolean;
    /**
     * 
     * @type {number}
     * @memberof Attendance
     */
    'time_settings_break_configuration_id'?: number | null;
}

type AttendanceLocationTypeEnum = 'office' | 'business_trip' | 'work_from_home'
type AttendanceHalfDayEnum = 'beginning_of_day' | 'end_of_day'
