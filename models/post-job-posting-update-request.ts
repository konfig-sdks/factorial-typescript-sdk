 ...
 * 
 * @export
 * @interface PostJobPostingUpdateRequest
 */
export interface PostJobPostingUpdateRequest {
    /**
     * 
     * @type {string}
     * @memberof PostJobPostingUpdateRequest
     */
    'title'?: string;
    /**
     * 
     ...
     * @memberof PostJobPostingUpdateRequest
     */
    'contract_type'?: PostJobPostingUpdateRequestContractTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof PostJobPostingUpdateRequest
     ...
     * @memberof PostJobPostingUpdateRequest
     */
    'status'?: PostJobPostingUpdateRequestStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof PostJobPostingUpdateRequest
     */
    'schedule_type'?: PostJobPostingUpdateRequestScheduleTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof PostJobPostingUpdateRequest
     ...
     * @memberof PostJobPostingUpdateRequest
     */
    'salary_format'?: PostJobPostingUpdateRequestSalaryFormatEnum;
    /**
     * 
     * @type {number}
     * @memberof PostJobPostingUpdateRequest
     ...
     * @memberof PostJobPostingUpdateRequest
     */
    'cv_requirement'?: PostJobPostingUpdateRequestCvRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostJobPostingUpdateRequest
     */
    'cover_letter_requirement'?: PostJobPostingUpdateRequestCoverLetterRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostJobPostingUpdateRequest
     */
    'phone_requirement'?: PostJobPostingUpdateRequestPhoneRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostJobPostingUpdateRequest
     */
    'photo_requirement'?: PostJobPostingUpdateRequestPhotoRequirementEnum;
}

type PostJobPostingUpdateRequestContractTypeEnum = 'indefinite' | 'temporary' | 'fixed_discontinued' | 'intern' | 'training'
type PostJobPostingUpdateRequestStatusEnum = 'draft' | 'published' | 'unlisted' | 'archived' | 'cancelled'
type PostJobPostingUpdateRequestScheduleTypeEnum = 'full_time' | 'part_time'
type PostJobPostingUpdateRequestSalaryFormatEnum = 'range' | 'fixed_amount'
type PostJobPostingUpdateRequestCvRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostJobPostingUpdateRequestCoverLetterRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostJobPostingUpdateRequestPhoneRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostJobPostingUpdateRequestPhotoRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
