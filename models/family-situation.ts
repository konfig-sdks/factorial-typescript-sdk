...
export interface FamilySituation {
     ...
     * @memberof FamilySituation
     */
    'civil_status'?: FamilySituationCivilStatusEnum;
    /**
     * 
     * @type {number}
     * @memberof FamilySituation
...
type FamilySituationCivilStatusEnum = 'single' | 'cohabitating' | 'divorced' | 'married' | 'unknown' | 'civil_partnership' | 'separated' | 'widow' | 'not_applicable'
