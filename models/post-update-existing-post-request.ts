 ...
 * 
 * @export
 * @interface PostUpdateExistingPostRequest
 */
export interface PostUpdateExistingPostRequest {
    /**
     * 
     * @type {string}
     * @memberof PostUpdateExistingPostRequest
     */
    'title'?: string;
    /**
     * 
     ...
     * @memberof PostUpdateExistingPostRequest
     */
    'deleted_attachments'?: Array<number>;
}
