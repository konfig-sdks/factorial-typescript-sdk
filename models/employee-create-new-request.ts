 ...
 * 
 * @export
 * @interface EmployeeCreateNewRequest
 */
export interface EmployeeCreateNewRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeeCreateNewRequest
     */
    'email': string;
    /**
     * 
     ...
     * @memberof EmployeeCreateNewRequest
     */
    'role'?: EmployeeCreateNewRequestRoleEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeCreateNewRequest
     */
    'gender'?: EmployeeCreateNewRequestGenderEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeCreateNewRequest
     ...
     * @memberof EmployeeCreateNewRequest
     */
    'identifier_type'?: EmployeeCreateNewRequestIdentifierTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeCreateNewRequest
...
type EmployeeCreateNewRequestRoleEnum = 'basic' | 'admin'
type EmployeeCreateNewRequestGenderEnum = 'male' | 'female'
type EmployeeCreateNewRequestIdentifierTypeEnum = 'dni' | 'nie' | 'passport'
