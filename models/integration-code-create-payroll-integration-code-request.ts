 ...
 * 
 * @export
 * @interface IntegrationCodeCreatePayrollIntegrationCodeRequest
 */
export interface IntegrationCodeCreatePayrollIntegrationCodeRequest {
    /**
     * 
     * @type {string}
     * @memberof IntegrationCodeCreatePayrollIntegrationCodeRequest
     */
    'code': string;
    /**
     * 
     ...
     * @memberof IntegrationCodeCreatePayrollIntegrationCodeRequest
     */
    'codeable_type': IntegrationCodeCreatePayrollIntegrationCodeRequestCodeableTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof IntegrationCodeCreatePayrollIntegrationCodeRequest
     */
    'integration': IntegrationCodeCreatePayrollIntegrationCodeRequestIntegrationEnum;
    /**
     * 
     * @type {boolean}
     * @memberof IntegrationCodeCreatePayrollIntegrationCodeRequest
...
type IntegrationCodeCreatePayrollIntegrationCodeRequestCodeableTypeEnum = 'Company' | 'Employee' | 'CompanyCodeEnabled' | 'CompanyDbFile' | 'LegalEntity' | 'CompanyTentantId' | 'WorkplaceCodeEnabled' | 'ContractsCompensationsTaxonomy' | 'TimeoffLeaveType' | 'Location' | 'Bookkeper' | 'ValidFrom'
type IntegrationCodeCreatePayrollIntegrationCodeRequestIntegrationEnum = 'a3innuva' | 'a3nom' | 'silae' | 'datev' | 'zuccheti' | 'kombo' | 'parieh'
