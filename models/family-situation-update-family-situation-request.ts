 ...
 * 
 * @export
 * @interface FamilySituationUpdateFamilySituationRequest
 */
export interface FamilySituationUpdateFamilySituationRequest {
    /**
     * 
     * @type {number}
     * @memberof FamilySituationUpdateFamilySituationRequest
     */
    'employee_id'?: number;
    /**
     * 
     ...
     * @memberof FamilySituationUpdateFamilySituationRequest
     */
    'civil_status'?: FamilySituationUpdateFamilySituationRequestCivilStatusEnum;
    /**
     * 
     * @type {number}
     * @memberof FamilySituationUpdateFamilySituationRequest
...
type FamilySituationUpdateFamilySituationRequestCivilStatusEnum = 'single' | 'cohabitating' | 'divorced' | 'married' | 'unknown' | 'civil_partnership' | 'separated' | 'widow' | 'not_applicable'
