 ...
 * 
 * @export
 * @interface CompensationCreateContractCompensationRequest
 */
export interface CompensationCreateContractCompensationRequest {
    /**
     * 
     * @type {string}
     * @memberof CompensationCreateContractCompensationRequest
     */
    'description'?: string;
    /**
     * 
     ...
     * @memberof CompensationCreateContractCompensationRequest
     */
    'compensation_type'?: CompensationCreateContractCompensationRequestCompensationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof CompensationCreateContractCompensationRequest
     ...
     * @memberof CompensationCreateContractCompensationRequest
     */
    'unit'?: CompensationCreateContractCompensationRequestUnitEnum;
    /**
     * 
     * @type {boolean}
     * @memberof CompensationCreateContractCompensationRequest
     ...
     * @memberof CompensationCreateContractCompensationRequest
     */
    'recurrence'?: CompensationCreateContractCompensationRequestRecurrenceEnum;
    /**
     * 
     * @type {string}
     * @memberof CompensationCreateContractCompensationRequest
     ...
     * @memberof CompensationCreateContractCompensationRequest
     */
    'calculation'?: CompensationCreateContractCompensationRequestCalculationEnum;
}

type CompensationCreateContractCompensationRequestCompensationTypeEnum = 'fixed' | 'up_to'
type CompensationCreateContractCompensationRequestUnitEnum = 'money' | 'units'
type CompensationCreateContractCompensationRequestRecurrenceEnum = 'monthly' | 'every_2_months' | 'every_3_months' | 'every_4_months' | 'every_5_months' | 'every_6_months' | 'every_7_months' | 'every_8_months' | 'every_9_months' | 'every_10_months' | 'every_11_months' | 'every_12_months'
type CompensationCreateContractCompensationRequestCalculationEnum = 'current_period' | 'previous_period\''
