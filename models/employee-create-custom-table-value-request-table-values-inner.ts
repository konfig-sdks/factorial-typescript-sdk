 ...
 * 
 * @export
 * @interface EmployeeCreateCustomTableValueRequestTableValuesInner
 */
export interface EmployeeCreateCustomTableValueRequestTableValuesInner {
    /**
     * The id of the table custom field
     * @type {number}
     * @memberof EmployeeCreateCustomTableValueRequestTableValuesInner
     */
    'id': number;
    /**
