...
import { TableCreateFieldRequestCustomField } from './table-create-field-request-custom-field';

/**
 * 
 * @export
 * @interface TableCreateFieldRequest
 */
export interface TableCreateFieldRequest {
    /**
     * The id of the custom table
     * @type {number}
     * @memberof TableCreateFieldRequest
     */
    'id': number;
    /**
     * 
     * @type {TableCreateFieldRequestCustomField}
     * @memberof TableCreateFieldRequest
     */
    'custom_field'?: TableCreateFieldRequestCustomField;
}
