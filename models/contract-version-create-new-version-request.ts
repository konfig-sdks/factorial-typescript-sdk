 ...
 * 
 * @export
 * @interface ContractVersionCreateNewVersionRequest
 */
export interface ContractVersionCreateNewVersionRequest {
    /**
     * 
     * @type {string}
     * @memberof ContractVersionCreateNewVersionRequest
     */
    'effective_on'?: string;
    /**
     * 
     ...
     * @memberof ContractVersionCreateNewVersionRequest
     */
    'working_hours_frequency'?: ContractVersionCreateNewVersionRequestWorkingHoursFrequencyEnum;
    /**
     * 
     * @type {string}
     * @memberof ContractVersionCreateNewVersionRequest
     ...
     * @memberof ContractVersionCreateNewVersionRequest
     */
    'salary_frequency'?: ContractVersionCreateNewVersionRequestSalaryFrequencyEnum;
    /**
     * 
     * @type {number}
     * @memberof ContractVersionCreateNewVersionRequest
...
type ContractVersionCreateNewVersionRequestWorkingHoursFrequencyEnum = 'week' | 'day' | 'month' | 'year'
type ContractVersionCreateNewVersionRequestSalaryFrequencyEnum = 'yearly' | 'monthly' | 'weekly' | 'hourly' | 'daily'
