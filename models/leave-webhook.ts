 ...
 * 
 * @export
 * @interface LeaveWebhook
 */
export interface LeaveWebhook {
    /**
     * 
     * @type {number}
     * @memberof LeaveWebhook
     */
    'id'?: number;
    /**
     * 
     ...
     * @memberof LeaveWebhook
     */
    'half_day'?: LeaveWebhookHalfDayEnum;
    /**
     * 
     * @type {number}
     * @memberof LeaveWebhook
...
type LeaveWebhookHalfDayEnum = 'beggining_of_day' | 'end_of_day'
