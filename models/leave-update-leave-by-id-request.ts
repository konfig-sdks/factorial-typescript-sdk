 ...
 * 
 * @export
 * @interface LeaveUpdateLeaveByIdRequest
 */
export interface LeaveUpdateLeaveByIdRequest {
    /**
     * 
     * @type {string}
     * @memberof LeaveUpdateLeaveByIdRequest
     */
    'description'?: string;
    /**
     * 
     ...
     * @memberof LeaveUpdateLeaveByIdRequest
     */
    'half_day'?: LeaveUpdateLeaveByIdRequestHalfDayEnum;
    /**
     * 
     * @type {number}
     * @memberof LeaveUpdateLeaveByIdRequest
...
type LeaveUpdateLeaveByIdRequestHalfDayEnum = 'beggining_of_day' | 'end_of_day'
