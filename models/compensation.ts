...
export interface Compensation {
     ...
     * @memberof Compensation
     */
    'compensation_type'?: CompensationCompensationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof Compensation
     ...
     * @memberof Compensation
     */
    'recurrence'?: CompensationRecurrenceEnum;
    /**
     * 
     * @type {string}
     * @memberof Compensation
     ...
     * @memberof Compensation
     */
    'calculation'?: CompensationCalculationEnum;
}

type CompensationCompensationTypeEnum = 'fixed' | 'up_to'
type CompensationRecurrenceEnum = 'monthly' | 'every_2_months' | 'every_3_months' | 'every_4_months' | 'every_5_months' | 'every_6_months' | 'every_7_months' | 'every_8_months' | 'every_9_months' | 'every_10_months' | 'every_11_months' | 'every_12_months'
type CompensationUnitEnum = 'money' | 'units'
type CompensationCalculationEnum = 'current_period' | 'previous_period\''
