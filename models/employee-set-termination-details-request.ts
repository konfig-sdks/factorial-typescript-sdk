 ...
 * 
 * @export
 * @interface EmployeeSetTerminationDetailsRequest
 */
export interface EmployeeSetTerminationDetailsRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeeSetTerminationDetailsRequest
     */
     ...
     * @memberof EmployeeSetTerminationDetailsRequest
     */
    'termination_reason_type'?: EmployeeSetTerminationDetailsRequestTerminationReasonTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof EmployeeSetTerminationDetailsRequest
...
type EmployeeSetTerminationDetailsRequestTerminationReasonTypeEnum = 'company' | 'employee' | 'others'
