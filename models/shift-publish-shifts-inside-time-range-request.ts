 ...
 * 
 * @export
 * @interface ShiftPublishShiftsInsideTimeRangeRequest
 */
export interface ShiftPublishShiftsInsideTimeRangeRequest {
    /**
     * 
     * @type {string}
     * @memberof ShiftPublishShiftsInsideTimeRangeRequest
     */
    'start_at'?: string;
    /**
     * 
