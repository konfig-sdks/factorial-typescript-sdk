...
import { EmployeeCreateCustomTableValueRequestTableValuesInner } from './employee-create-custom-table-value-request-table-values-inner';

/**
 * 
 * @export
 * @interface EmployeeCreateCustomTableValueRequest
 */
export interface EmployeeCreateCustomTableValueRequest {
    /**
     * The id of the custom table
     * @type {number}
     * @memberof EmployeeCreateCustomTableValueRequest
     */
    'id': number;
    /**
    ...
    /**
     * 
     * @type {Array<EmployeeCreateCustomTableValueRequestTableValuesInner>}
     * @memberof EmployeeCreateCustomTableValueRequest
     */
    'table_values'?: Array<EmployeeCreateCustomTableValueRequestTableValuesInner>;
}
