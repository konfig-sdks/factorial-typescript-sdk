 ...
 * 
 * @export
 * @interface EmployeeUpdateEmployeeByIdRequest
 */
export interface EmployeeUpdateEmployeeByIdRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeeUpdateEmployeeByIdRequest
     */
    'email'?: string;
    /**
     * 
     ...
     * @memberof EmployeeUpdateEmployeeByIdRequest
     */
    'role'?: EmployeeUpdateEmployeeByIdRequestRoleEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeUpdateEmployeeByIdRequest
     */
    'gender'?: EmployeeUpdateEmployeeByIdRequestGenderEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeUpdateEmployeeByIdRequest
     ...
     * @memberof EmployeeUpdateEmployeeByIdRequest
     */
    'identifier_type'?: EmployeeUpdateEmployeeByIdRequestIdentifierTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeUpdateEmployeeByIdRequest
...
type EmployeeUpdateEmployeeByIdRequestRoleEnum = 'basic' | 'admin'
type EmployeeUpdateEmployeeByIdRequestGenderEnum = 'male' | 'female'
type EmployeeUpdateEmployeeByIdRequestIdentifierTypeEnum = 'dni' | 'nie' | 'passport'
