 ...
 * 
 * @export
 * @interface CustomFieldCreateFieldRequestChoiceOptionsInner
 */
export interface CustomFieldCreateFieldRequestChoiceOptionsInner {
    /**
     * 
     * @type {string}
     * @memberof CustomFieldCreateFieldRequestChoiceOptionsInner
     */
    'label'?: string;
    /**
     * 
