 ...
 * 
 * @export
 * @interface CustomFieldValueCreateCustomValueRequest
 */
export interface CustomFieldValueCreateCustomValueRequest {
    /**
     * 
     * @type {string}
     * @memberof CustomFieldValueCreateCustomValueRequest
     */
    'value': string;
}
