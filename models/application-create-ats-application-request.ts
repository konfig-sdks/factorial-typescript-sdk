...
import { ApplicationCreateAtsApplicationRequestAnswersInner } from './application-create-ats-application-request-answers-inner';

/**
 * 
 * @export
 * @interface ApplicationCreateAtsApplicationRequest
 */
export interface ApplicationCreateAtsApplicationRequest {
    /**
     * 
     * @type {number}
     * @memberof ApplicationCreateAtsApplicationRequest
     */
     ...
     * @memberof ApplicationCreateAtsApplicationRequest
     */
    'source': ApplicationCreateAtsApplicationRequestSourceEnum;
    /**
     * 
     * @type {string}
     * @memberof ApplicationCreateAtsApplicationRequest
     ...
     * @memberof ApplicationCreateAtsApplicationRequest
     */
    'cv'?: Uint8Array | File | buffer.File;
    /**
     * 
     * @type {Uint8Array | File | buffer.File}
     * @memberof ApplicationCreateAtsApplicationRequest
     ...
     * @memberof ApplicationCreateAtsApplicationRequest
     */
    'answers'?: Array<ApplicationCreateAtsApplicationRequestAnswersInner>;
}

type ApplicationCreateAtsApplicationRequestSourceEnum = 'indeed' | 'linkedin' | 'JobTarget' | 'manually_added' | 'organic' | 'jobposting' | 'JOIN'
