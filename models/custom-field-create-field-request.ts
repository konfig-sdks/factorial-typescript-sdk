...
import { CustomFieldCreateFieldRequestChoiceOptionsInner } from './custom-field-create-field-request-choice-options-inner';

/**
 * 
 * @export
 * @interface CustomFieldCreateFieldRequest
 */
export interface CustomFieldCreateFieldRequest {
    /**
     * 
     * @type {string}
     * @memberof CustomFieldCreateFieldRequest
     */
    'label': string;
    /**
     * 
     ...
     * @memberof CustomFieldCreateFieldRequest
     */
    'field_type': CustomFieldCreateFieldRequestFieldTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof CustomFieldCreateFieldRequest
     ...
     * @memberof CustomFieldCreateFieldRequest
     */
    'editable': CustomFieldCreateFieldRequestEditableEnum;
    /**
     * 
     * @type {string}
     * @memberof CustomFieldCreateFieldRequest
     */
    'visible': CustomFieldCreateFieldRequestVisibleEnum;
    /**
     * 
     * @type {Array<CustomFieldCreateFieldRequestChoiceOptionsInner>}
     * @memberof CustomFieldCreateFieldRequest
     */
    'choice_options'?: Array<CustomFieldCreateFieldRequestChoiceOptionsInner>;
}

type CustomFieldCreateFieldRequestFieldTypeEnum = 'text' | 'long_text' | 'number' | 'single_choice'
type CustomFieldCreateFieldRequestEditableEnum = 'owned' | 'reportees' | 'team_leader' | 'everybody'
type CustomFieldCreateFieldRequestVisibleEnum = 'owned' | 'reportees' | 'team_leader' | 'everybody'
