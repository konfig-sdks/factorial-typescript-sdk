...
import { TableCreateFieldRequestCustomFieldChoiceOptions } from './table-create-field-request-custom-field-choice-options';

/**
 * 
 * @export
 * @interface TableCreateFieldRequestCustomField
 */
export interface TableCreateFieldRequestCustomField {
    /**
     * 
     * @type {number}
     * @memberof TableCreateFieldRequestCustomField
     */
    'id'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {TableCreateFieldRequestCustomFieldChoiceOptions}
     * @memberof TableCreateFieldRequestCustomField
     */
