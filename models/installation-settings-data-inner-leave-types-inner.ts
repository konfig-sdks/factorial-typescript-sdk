 ...
 * 
 * @export
 * @interface InstallationSettingsDataInnerLeaveTypesInner
 */
export interface InstallationSettingsDataInnerLeaveTypesInner {
    /**
     * 
     * @type {string}
     * @memberof InstallationSettingsDataInnerLeaveTypesInner
     */
    'id'?: string;
    /**
     * 
