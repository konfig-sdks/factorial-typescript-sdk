 ...
 * 
 * @export
 * @interface CandidateCreateNewCandidateRequest
 */
export interface CandidateCreateNewCandidateRequest {
    /**
     * 
     * @type {string}
     * @memberof CandidateCreateNewCandidateRequest
     */
    'first_name': string;
    /**
     * 
     ...
     * @memberof CandidateCreateNewCandidateRequest
     */
    'source'?: CandidateCreateNewCandidateRequestSourceEnum;
    /**
     * 
     * @type {string}
     * @memberof CandidateCreateNewCandidateRequest
...
type CandidateCreateNewCandidateRequestSourceEnum = 'indeed' | 'linkedin' | 'JobTarget' | 'manually_added' | 'organic' | 'jobposting' | 'JOIN'
