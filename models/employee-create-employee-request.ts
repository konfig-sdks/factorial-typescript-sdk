 ...
 * 
 * @export
 * @interface EmployeeCreateEmployeeRequest
 */
export interface EmployeeCreateEmployeeRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeeCreateEmployeeRequest
     */
    'email': string;
    /**
     * 
     ...
     * @memberof EmployeeCreateEmployeeRequest
     */
    'regular_access_starts_on'?: string;
    /**
     * 
     * @type {number}
     * @memberof EmployeeCreateEmployeeRequest
     ...
     * @memberof EmployeeCreateEmployeeRequest
     */
    'role'?: EmployeeCreateEmployeeRequestRoleEnum;
    /**
     * 
     * @type {number}
     * @memberof EmployeeCreateEmployeeRequest
...
type EmployeeCreateEmployeeRequestRoleEnum = 'basic' | 'admin'
