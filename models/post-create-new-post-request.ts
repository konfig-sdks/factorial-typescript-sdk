 ...
 * 
 * @export
 * @interface PostCreateNewPostRequest
 */
export interface PostCreateNewPostRequest {
    /**
     * 
     * @type {string}
     * @memberof PostCreateNewPostRequest
     */
    'title': string;
    /**
     * 
     ...
     * @memberof PostCreateNewPostRequest
     */
    'type': PostCreateNewPostRequestTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof PostCreateNewPostRequest
     ...
     * @memberof PostCreateNewPostRequest
     */
    'image'?: Uint8Array | File | buffer.File;
    /**
     * 
     * @type {boolean}
     * @memberof PostCreateNewPostRequest
     ...
     * @memberof PostCreateNewPostRequest
     */
    'attachments'?: Uint8Array | File | buffer.File;
}

type PostCreateNewPostRequestTypeEnum = 'event' | 'announcement' | 'first_day' | 'birthday' | 'workiversary'
