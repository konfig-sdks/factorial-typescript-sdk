 ...
 * 
 * @export
 * @interface CompensationUpdateForContractRequest
 */
export interface CompensationUpdateForContractRequest {
    /**
     * 
     * @type {string}
     * @memberof CompensationUpdateForContractRequest
     */
    'description'?: string;
    /**
     * 
     ...
     * @memberof CompensationUpdateForContractRequest
     */
    'compensation_type'?: CompensationUpdateForContractRequestCompensationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof CompensationUpdateForContractRequest
     ...
     * @memberof CompensationUpdateForContractRequest
     */
    'unit'?: CompensationUpdateForContractRequestUnitEnum;
    /**
     * 
     * @type {boolean}
     * @memberof CompensationUpdateForContractRequest
     ...
     * @memberof CompensationUpdateForContractRequest
     */
    'recurrence'?: CompensationUpdateForContractRequestRecurrenceEnum;
    /**
     * 
     * @type {string}
     * @memberof CompensationUpdateForContractRequest
     ...
     * @memberof CompensationUpdateForContractRequest
     */
    'calculation'?: CompensationUpdateForContractRequestCalculationEnum;
}

type CompensationUpdateForContractRequestCompensationTypeEnum = 'fixed' | 'up_to'
type CompensationUpdateForContractRequestUnitEnum = 'money' | 'units'
type CompensationUpdateForContractRequestRecurrenceEnum = 'monthly' | 'every_2_months' | 'every_3_months' | 'every_4_months' | 'every_5_months' | 'every_6_months' | 'every_7_months' | 'every_8_months' | 'every_9_months' | 'every_10_months' | 'every_11_months' | 'every_12_months'
type CompensationUpdateForContractRequestCalculationEnum = 'current_period' | 'previous_period\''
