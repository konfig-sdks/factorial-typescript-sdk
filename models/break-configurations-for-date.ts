...
import { BreakConfiguration } from './break-configuration';

/**
 * 
 * @export
 * @interface BreakConfigurationsForDate
 */
export interface BreakConfigurationsForDate {
    /**
     * 
     * @type {string}
     * @memberof BreakConfigurationsForDate
     */
    'date'?: string;
    /**
     * 
     * @type {Array<BreakConfiguration>}
     * @memberof BreakConfigurationsForDate
     */
    'break_configurations'?: Array<BreakConfiguration>;
}
