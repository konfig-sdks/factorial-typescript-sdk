 ...
 * 
 * @export
 * @interface ApplicationUpdateDataRequest
 */
export interface ApplicationUpdateDataRequest {
    /**
     * 
     * @type {number}
     * @memberof ApplicationUpdateDataRequest
     */
     ...
     * @memberof ApplicationUpdateDataRequest
     */
    'disqualified_reason'?: ApplicationUpdateDataRequestDisqualifiedReasonEnum;
    /**
     * 
...
type ApplicationUpdateDataRequestDisqualifiedReasonEnum = 'not_a_fit' | 'self_disqualified' | 'salary' | 'other_reason' | 'underqualified' | 'offer_not_accepted' | 'other_offer' | 'no_response'
