 ...
 * 
 * @export
 * @interface AttendanceCreateNewRequest
 */
export interface AttendanceCreateNewRequest {
    /**
     * 
     * @type {number}
     * @memberof AttendanceCreateNewRequest
     */
    'employee_id': number;
    /**
     * 
     ...
     * @memberof AttendanceCreateNewRequest
     */
    'location_type'?: AttendanceCreateNewRequestLocationTypeEnum;
}

type AttendanceCreateNewRequestLocationTypeEnum = 'office' | 'business_trip' | 'work_from_home'
