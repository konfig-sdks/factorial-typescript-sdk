 ...
 * 
 * @export
 * @interface AtsQuestion
 */
export interface AtsQuestion {
    /**
     * 
     * @type {number}
     * @memberof AtsQuestion
     */
    'id': number;
    /**
     * 
     ...
     * @memberof AtsQuestion
     */
    'question_type': AtsQuestionQuestionTypeEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof AtsQuestion
...
type AtsQuestionQuestionTypeEnum = 'file' | 'single_choice' | 'multiple_choice' | 'text' | 'long_text'
