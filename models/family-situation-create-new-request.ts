 ...
 * 
 * @export
 * @interface FamilySituationCreateNewRequest
 */
export interface FamilySituationCreateNewRequest {
    /**
     * 
     * @type {number}
     * @memberof FamilySituationCreateNewRequest
     */
    'employee_id': number;
    /**
     * 
     ...
     * @memberof FamilySituationCreateNewRequest
     */
    'civil_status': FamilySituationCreateNewRequestCivilStatusEnum;
    /**
     * 
     * @type {number}
     * @memberof FamilySituationCreateNewRequest
...
type FamilySituationCreateNewRequestCivilStatusEnum = 'single' | 'cohabitating' | 'divorced' | 'married' | 'unknown' | 'civil_partnership' | 'separated' | 'widow' | 'not_applicable'
