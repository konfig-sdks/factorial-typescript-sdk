 ...
 * 
 * @export
 * @interface TableCreateFieldRequestCustomFieldChoiceOptions
 */
export interface TableCreateFieldRequestCustomFieldChoiceOptions {
    /**
     * 
     * @type {number}
     * @memberof TableCreateFieldRequestCustomFieldChoiceOptions
     */
    'id'?: number;
    /**
     * 
