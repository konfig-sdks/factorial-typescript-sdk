 ...
 * 
 * @export
 * @interface EmployeeHiring
 */
export interface EmployeeHiring {
    /**
     * 
     * @type {number}
     * @memberof EmployeeHiring
     */
    'base_compensation_amount_in_cents'?: number;
    /**
     * 
     * @type {string}
     * @memberof EmployeeHiring
     */
    'base_compensation_type'?: EmployeeHiringBaseCompensationTypeEnum;
}

type EmployeeHiringBaseCompensationTypeEnum = 'yearly' | 'monthly' | 'weekly' | 'hourly'
