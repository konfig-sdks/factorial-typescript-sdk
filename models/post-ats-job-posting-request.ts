 ...
 * 
 * @export
 * @interface PostAtsJobPostingRequest
 */
export interface PostAtsJobPostingRequest {
    /**
     * 
     * @type {string}
     * @memberof PostAtsJobPostingRequest
     */
    'title': string;
    /**
     * 
     ...
     * @memberof PostAtsJobPostingRequest
     */
    'contract_type'?: PostAtsJobPostingRequestContractTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof PostAtsJobPostingRequest
     ...
     * @memberof PostAtsJobPostingRequest
     */
    'status': PostAtsJobPostingRequestStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof PostAtsJobPostingRequest
     */
    'schedule_type'?: PostAtsJobPostingRequestScheduleTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof PostAtsJobPostingRequest
     ...
     * @memberof PostAtsJobPostingRequest
     */
    'salary_format'?: PostAtsJobPostingRequestSalaryFormatEnum;
    /**
     * 
     * @type {number}
     * @memberof PostAtsJobPostingRequest
     ...
     * @memberof PostAtsJobPostingRequest
     */
    'cv_requirement'?: PostAtsJobPostingRequestCvRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostAtsJobPostingRequest
     */
    'cover_letter_requirement'?: PostAtsJobPostingRequestCoverLetterRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostAtsJobPostingRequest
     */
    'phone_requirement'?: PostAtsJobPostingRequestPhoneRequirementEnum;
    /**
     * 
     * @type {string}
     * @memberof PostAtsJobPostingRequest
     */
    'photo_requirement'?: PostAtsJobPostingRequestPhotoRequirementEnum;
}

type PostAtsJobPostingRequestContractTypeEnum = 'indefinite' | 'temporary' | 'fixed_discontinued' | 'intern' | 'training'
type PostAtsJobPostingRequestStatusEnum = 'draft' | 'published' | 'unlisted' | 'archived' | 'cancelled'
type PostAtsJobPostingRequestScheduleTypeEnum = 'full_time' | 'part_time'
type PostAtsJobPostingRequestSalaryFormatEnum = 'range' | 'fixed_amount'
type PostAtsJobPostingRequestCvRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostAtsJobPostingRequestCoverLetterRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostAtsJobPostingRequestPhoneRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
type PostAtsJobPostingRequestPhotoRequirementEnum = 'mandatory' | 'optional' | 'do_not_ask'
