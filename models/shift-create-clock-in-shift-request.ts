 ...
 * 
 * @export
 * @interface ShiftCreateClockInShiftRequest
 */
export interface ShiftCreateClockInShiftRequest {
    /**
     * 
     * @type {number}
     * @memberof ShiftCreateClockInShiftRequest
     */
    'employee_id': number;
    /**
     * 
     ...
     * @memberof ShiftCreateClockInShiftRequest
     */
    'location_type'?: ShiftCreateClockInShiftRequestLocationTypeEnum;
}

type ShiftCreateClockInShiftRequestLocationTypeEnum = 'office' | 'business_trip' | 'work_from_home'
