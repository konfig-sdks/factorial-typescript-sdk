 ...
 * 
 * @export
 * @interface LeaveCreateNewLeaveRequest
 */
export interface LeaveCreateNewLeaveRequest {
    /**
     * 
     * @type {string}
     * @memberof LeaveCreateNewLeaveRequest
     */
    'description'?: string;
    /**
     * 
     ...
     * @memberof LeaveCreateNewLeaveRequest
     */
    'half_day'?: LeaveCreateNewLeaveRequestHalfDayEnum;
}

type LeaveCreateNewLeaveRequestHalfDayEnum = 'beggining_of_day' | 'end_of_day'
