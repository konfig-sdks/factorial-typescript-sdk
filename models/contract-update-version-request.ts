 ...
 * 
 * @export
 * @interface ContractUpdateVersionRequest
 */
export interface ContractUpdateVersionRequest {
    /**
     * 
     * @type {string}
     * @memberof ContractUpdateVersionRequest
     */
    'effective_on': string;
    /**
     * 
     ...
     * @memberof ContractUpdateVersionRequest
     */
    'working_hours_frequency'?: ContractUpdateVersionRequestWorkingHoursFrequencyEnum;
    /**
     * 
     * @type {string}
     * @memberof ContractUpdateVersionRequest
     ...
     * @memberof ContractUpdateVersionRequest
     */
    'salary_frequency'?: ContractUpdateVersionRequestSalaryFrequencyEnum;
    /**
     * 
     * @type {number}
     * @memberof ContractUpdateVersionRequest
     ...
     * @memberof ContractUpdateVersionRequest
     */
    'es_cotization_group'?: number | null;
    /**
     * the professional category id for Spain contracts
     * @type {number}
     * @memberof ContractUpdateVersionRequest
     */
    'es_professional_category_id'?: number | null;
    /**
     * the education level id for Spain contracts
     * @type {number}
     * @memberof ContractUpdateVersionRequest
     */
    'es_education_level_id'?: number | null;
    /**
     * the contract type id for Spain contracts
     * @type {number}
     * @memberof ContractUpdateVersionRequest
     */
    'es_contract_type_id'?: number | null;
}

type ContractUpdateVersionRequestWorkingHoursFrequencyEnum = 'week' | 'day' | 'month' | 'year'
type ContractUpdateVersionRequestSalaryFrequencyEnum = 'yearly' | 'monthly' | 'weekly' | 'hourly' | 'daily'
