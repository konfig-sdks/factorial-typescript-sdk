...
import { ApplicationCreateAtsApplicationRequestAnswersInnerValue } from './application-create-ats-application-request-answers-inner-value';

/**
 * 
 * @export
 * @interface ApplicationCreateAtsApplicationRequestAnswersInner
 */
export interface ApplicationCreateAtsApplicationRequestAnswersInner {
    /**
     * 
     * @type {number}
     * @memberof ApplicationCreateAtsApplicationRequestAnswersInner
     */
    'ats_question_id': number;
    /**
     * 
     * @type {ApplicationCreateAtsApplicationRequestAnswersInnerValue}
     * @memberof ApplicationCreateAtsApplicationRequestAnswersInner
     */
    'value': ApplicationCreateAtsApplicationRequestAnswersInnerValue;
}
