...
export class Factorial extends FactorialCustom {
  ...
  readonly workplace: WorkplaceApi;
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.break = new BreakApi(configuration);
    this.candidate = new CandidateApi(configuration);
    this.compensation = new CompensationApi(configuration);
    this.contract = new ContractApi(configuration);
    this.contractVersion = new ContractVersionApi(configuration);
    this.customField = new CustomFieldApi(configuration);
    this.customFieldValue = new CustomFieldValueApi(configuration);
    this.customTable = new CustomTableApi(configuration);
    ...
    this.familySituation = new FamilySituationApi(configuration);
    this.folder = new FolderApi(configuration);
    this.holiday = new HolidayApi(configuration);
    this.integration = new IntegrationApi(configuration);
    this.integrationCode = new IntegrationCodeApi(configuration);
    this.key = new KeyApi(configuration);
    this.leave = new LeaveApi(configuration);
    this.legalEntity = new LegalEntityApi(configuration);
    this.location = new LocationApi(configuration);
    this.message = new MessageApi(configuration);
    this.policy = new PolicyApi(configuration);
    this.post = new PostApi(configuration);
    this.shift = new ShiftApi(configuration);
    this.supplement = new SupplementApi(configuration);
    this.table = new TableApi(configuration);
    this.task = new TaskApi(configuration);
    this.taxonomy = new TaxonomyApi(configuration);
    this.team = new TeamApi(configuration);
    this.user = new UserApi(configuration);
    this.webhook = new WebhookApi(configuration);
    this.workplace = new WorkplaceApi(configuration);
  }
